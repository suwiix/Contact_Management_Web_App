...
@WebServlet(value = "/searchContact")
...
public class SearchContactController extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            contactList =  contactDAO.searchContact(id,req.getParameter("fname"),req.getParameter("lname"));
        } catch (SQLException | ClassNotFoundException e) {
            System.out.println(e);
            throw new RuntimeException(e);
        }
        writer.print("<table border='1' width='100%'");
        writer.print("<tr><th>ContactId</th><th>FirstName</th><th>LastName</th><th>Phone_Number</th>" +
